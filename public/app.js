...
function poolState(x){const e=new Date(x.end_date+'T23:59:59'),t=poolToday(),days=Math.ceil((e-t)/86400000);if(days<0)return {key:'expired',label:'Đã hết hạn',days};if(days<=3)return {key:'soon',label:'Sắp hết hạn',days};return {key:'valid',label:'Còn hạn',days}}

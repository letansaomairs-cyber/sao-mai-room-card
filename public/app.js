// ROOM CARD MANAGER - PARTIAL COMPENSATION V4 - 2026-08-08
...
function RA(){
  ...
  // Tổng nghĩa vụ bồi thường của tất cả phiếu có thẻ mất.
...
function AB(x){
  ...
  // Có thẻ mất chưa thu đủ tiền -> luôn cho phép thu một phần.
  if(unpaid > 0){
    buttons += `
      <button
  ...
  // Chỉ hủy phiếu khi chưa phát sinh trả/mất/thu phí.
  if(
